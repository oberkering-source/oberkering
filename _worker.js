...
let proxyIP = "https://raw.githubusercontent.com/FoolVPN-ID/Nautica/refs/heads/main/kvProxyList.json";
let cachedProxyList = [];
...
const DONATE_LINK = "https://www.paypal.com/paypalme/frankymior";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Anky-47 Vpn & Proxy</span>");
...
<html lang="en" id="html" class="scroll-auto scrollbar-hide dark">
  <head>
    ...
    <title>Welcome To ANKY-47 VPN & Proxy</title>
